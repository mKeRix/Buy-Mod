...
MACRO_CONFIG_INT(sv_tournament_mode, 1, 1, 1, CFGFLAG_SERVER, "Tournament mode. When enabled, players joins the server as spectator")
...
/* SQL */
MACRO_CONFIG_STR(sv_sql_user, 32, "nameless", CFGFLAG_SERVER, "SQL User")
MACRO_CONFIG_STR(sv_sql_pw, 32, "tee", CFGFLAG_SERVER, "SQL Password")
MACRO_CONFIG_STR(sv_sql_ip, 32, "127.0.0.1", CFGFLAG_SERVER, "SQL Database IP")
MACRO_CONFIG_INT(sv_sql_port, 0, 65535, 3306, CFGFLAG_SERVER, "SQL Database port")
MACRO_CONFIG_STR(sv_sql_database, 16, "teeworlds", CFGFLAG_SERVER, "SQL Database name")
MACRO_CONFIG_STR(sv_sql_prefix, 16, "tw", CFGFLAG_SERVER, "SQL Database table prefix")

/* Upgrades */
MACRO_CONFIG_STR(sv_upgr_0, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_1, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_2, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_3, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_4, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_5, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_6, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_7, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_8, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_9, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_10, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_11, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_12, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_13, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_14, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_15, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_16, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_17, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_18, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_19, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_20, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_21, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_22, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_23, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_24, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_25, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_26, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_27, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_28, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
MACRO_CONFIG_STR(sv_upgr_29, 32, "", CFGFLAG_SERVER, "price - lvl - cup")
